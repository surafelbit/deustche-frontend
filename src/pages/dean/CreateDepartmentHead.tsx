...
export default function CreateDepartmentHead() {
  ...
  const validateForm = () => {
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.phone || !formData.department || !formData.password) {
      toast({
    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Create a new department head account with login credentials
          </CardDescription>
        </CardHeader>
        <CardContent>
